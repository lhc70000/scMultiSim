...
The following figure shows the general simulation workflow of `scMultiSim`:

![scMultiSim Workflow](https://github.com/ZhangLabGT/scMultiSim/raw/img/img/sim_overview.png)
